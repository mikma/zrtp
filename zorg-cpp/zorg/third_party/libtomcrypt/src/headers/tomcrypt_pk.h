...
int  ecc_make_key_ex_2(void *read_random_state, unsigned long (*read_random)(unsigned char *out, unsigned long outlen, void * context), ecc_key *key, const ltc_ecc_set_type *dp);
